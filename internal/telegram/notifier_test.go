...
func TestMessageGroupsRecordingPlayback(t *testing.T) {
	...
	message := n.message([]model.Event{
		...
		{Kind: "recording_export_download", Actor: "bob", Camera: "doorbell", Details: "export_file=abc.mp4 export_name=Package at the front door", Protocol: "http", StartedAt: at.Add(2 * time.Minute)},
	})
	for _, want := range []string{
		...
		"<b>Export downloaded</b> — <code>doorbell</code>", "<i>“Package at the front door”</i>", "<code>export_file=abc.mp4</code>",
	} {
